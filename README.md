...
* ℹ **INFO** From a total of 1 font files, 1 of them (100.00%) lack a STAT table.
	...
	And these are the most common STAT axis orderings:
	 [code: summary]
* 💤 **SKIP** This font does not have a STAT table: Toshkua-Regular.otf [code: missing-STAT]
...
</div></details><details><summary>💤 <b>SKIP:</b> Does font file include unacceptable control character glyphs? (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/family/control_chars">com.google.fonts/check/family/control_chars</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[212] Toshkua-Regular.otf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Checking OS/2 fsType does not impose restrictions. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/fstype">com.google.fonts/check/fstype</a>)</summary><div>
...
| :--- | :--- | :--- |
| Family Name | Toshkua | Toshkua |
| Subfamily Name | Regular | Regular |
| Full Name | Toshkua Regular | Toshkua Regular |
| Poscript Name | Toshkua-Regular | Toshkua-Regular |
| Typographic Family Name | Toshkua | N/A |
...
>
* 🔥 **FAIL** .notdef glyphs were found when attempting to render Toshkua [code: render-own-name]
...
>
* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 1060, but got 1000 instead [code: ascent]
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 249, but got 200 instead. [code: descent]
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* exclam (U+0021): X=50.0,Y=1.0 (should be at baseline 0?)

	* exclam (U+0021): X=149.0,Y=1.0 (should be at baseline 0?)

	* dollar (U+0024): X=222.0,Y=1.0 (should be at baseline 0?)

	* comma (U+002C): X=65.0,Y=1.0 (should be at baseline 0?)

	* comma (U+002C): X=90.0,Y=1.0 (should be at baseline 0?)

	* comma (U+002C): X=164.0,Y=1.0 (should be at baseline 0?)

	* period (U+002E): X=60.0,Y=1.0 (should be at baseline 0?)

	* period (U+002E): X=159.0,Y=1.0 (should be at baseline 0?)

	* colon (U+003A): X=60.0,Y=1.0 (should be at baseline 0?)

	* colon (U+003A): X=164.0,Y=1.0 (should be at baseline 0?) 
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* ampersand (U+0026) contains a short segment L<<117.0,303.0>--<117.0,302.0>>

	* ampersand (U+0026) contains a short segment L<<442.0,0.0>--<450.0,0.0>>

	* two (U+0032) contains a short segment L<<68.0,98.0>--<66.0,98.0>>

	* three (U+0033) contains a short segment L<<149.0,693.0>--<148.0,694.0>>

	* four (U+0034) contains a short segment L<<76.0,312.0>--<75.0,312.0>>

	* five (U+0035) contains a short segment L<<86.0,738.0>--<85.0,738.0>>

	* five (U+0035) contains a short segment L<<86.0,456.0>--<87.0,456.0>>

	* five (U+0035) contains a short segment L<<87.0,456.0>--<86.0,455.0>>

	* A (U+0041) contains a short segment L<<315.0,790.0>--<314.0,787.0>>

	* A (U+0041) contains a short segment L<<314.0,787.0>--<313.0,790.0>> 
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* U (U+0055): L<<65.0,718.0>--<66.0,147.0>> -> L<<66.0,147.0>--<66.0,44.0>>

	* Uacute (U+00DA): L<<65.0,718.0>--<66.0,147.0>> -> L<<66.0,147.0>--<66.0,44.0>>

	* Udieresis (U+00DC): L<<65.0,718.0>--<66.0,147.0>> -> L<<66.0,147.0>--<66.0,44.0>> 

	* And Ugrave (U+00D9): L<<65.0,718.0>--<66.0,147.0>> -> L<<66.0,147.0>--<66.0,44.0>> [code: found-colinear-vectors]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* A (U+0041): L<<313.0,622.0>--<314.0,398.0>>

	* A (U+0041): L<<314.0,308.0>--<315.0,67.0>>

	* A (U+0041): L<<416.0,-30.0>--<414.0,790.0>>

	* AE (U+00C6): L<<336.0,622.0>--<337.0,398.0>>

	* AE (U+00C6): L<<337.0,308.0>--<338.0,95.0>>

	* AE (U+00C6): L<<438.0,402.0>--<437.0,705.0>>

	* AE (U+00C6): L<<439.0,92.0>--<438.0,303.0>>

	* Aacute (U+00C1): L<<313.0,622.0>--<314.0,398.0>>

	* Aacute (U+00C1): L<<314.0,308.0>--<315.0,67.0>>

	* Aacute (U+00C1): L<<416.0,-30.0>--<414.0,790.0>> 
...
</div></details><details><summary>💤 <b>SKIP:</b> Check license file has good copyright string. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/license/OFL_copyright">com.google.fonts/check/license/OFL_copyright</a>)</summary><div>
...
</div></details><details><summary>💤 <b>SKIP:</b> Check OFL body text is correct. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/license/OFL_body_text">com.google.fonts/check/license/OFL_body_text</a>)</summary><div>

>
>Check OFL body text is correct. Often users will accidently delete parts of the body text.
>
* 💤 **SKIP** Unfulfilled Conditions: is_ofl, license_contents
</div></details><details><summary>💤 <b>SKIP:</b> Check copyright namerecords match license file. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/name/license">com.google.fonts/check/name/license</a>)</summary><div>
...
* 💤 **SKIP** Font appears to our heuristic as not hinted using ttfautohint. [code: not-hinted]
</div></details><details><summary>💤 <b>SKIP:</b> Font has old ttfautohint applied? (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/old_ttfautohint">com.google.fonts/check/old_ttfautohint</a>)</summary><div>

>
>Check if font has been hinted with an outdated version of ttfautohint.
>
* 💤 **SKIP** Unfulfilled Conditions: is_ttf
</div></details><details><summary>💤 <b>SKIP:</b> Is the Grid-fitting and Scan-conversion Procedure ('gasp') table set to optimize rendering? (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/gasp">com.google.fonts/check/gasp</a>)</summary><div>
...
* 💤 **SKIP** Unfulfilled Conditions: font_metadata
</div></details><details><summary>💤 <b>SKIP:</b> Check glyphs do not have components which are themselves components. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/glyf_nested_components">com.google.fonts/check/glyf_nested_components</a>)</summary><div>
...
>
* 💤 **SKIP** Unfulfilled Conditions: is_variable_font
</div></details><details><summary>💤 <b>SKIP:</b> Font enables smart dropout control in "prep" table instructions? (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/smart_dropout">com.google.fonts/check/smart_dropout</a>)</summary><div>
...
>
* ℹ **INFO** Version string is: "Version 1.000;FEAKit 1.0"
...
>
* 🍞 **PASS** Font filename is correct, "Toshkua-Regular.otf".
